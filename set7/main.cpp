...
int main() {
    ...
    // This vector corresponds to the diagonal of the triangle defined by v1 and
    // v2
    v2d v5 = v1 + v2 * (-1);
    ...
    */
    ...
    cout << "Before w3 = w1 + w2 the length of w1 is... " << w1.length()
         << endl;
    w3 = w1 + w2;
    cout << "After  w3 = w1 + w2 the length of w1 is... " << w1.length()
         << endl;
